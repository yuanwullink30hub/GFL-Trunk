// Nebula shader sources — shared by nebulaEngine.js (which runs in a Web Worker on
// modern browsers, or on the main thread as fallback) and the dev nebula recorder.
// Extracted from NebulaBackground.jsx: a module worker cannot import a .jsx component.
...
export const NEBULA_FRAG = makeNebulaFrag(2, 2, 'highp', 3); // Desktop: 2 fbm/ridge octaves, 3 gas layers
