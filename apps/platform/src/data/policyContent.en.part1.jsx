  ...
  terms: (
    <>
      ...
      <ol style={S.ol} start={24}>
        ...
        <li style={S.li}>The application is given access only to the folder the User selects. It does not scan the device, does not access other folders, and sends no file listings to Garden For Life. The application remembers only the location of that folder, in its own data directory on the device.</li>
    ...
    <>
      ...
      <table style={S.table}>
        ...
        <tbody>
          ...
          <tr><td style={S.td}>gfl_session_ts</td><td style={S.td}>Until logout</td><td style={S.td}>Time of your last login — a session without a crystal code expires after 24 hours.</td></tr>
