  ...
  terms: (
    <>
      ...
      <ol style={S.ol} start={24}>
        ...
        <li style={S.li}>De applicatie krijgt uitsluitend toegang tot de map die de Gebruiker zelf aanwijst. Zij doorzoekt het apparaat niet, benadert geen andere mappen en verzendt geen bestandsoverzichten naar Garden For Life. De applicatie onthoudt uitsluitend de locatie van die map, in haar eigen gegevensmap op het apparaat.</li>
    ...
    <>
      ...
      <table style={S.table}>
        ...
        <tbody>
          ...
          <tr><td style={S.td}>gfl_session_ts</td><td style={S.td}>Tot uitloggen</td><td style={S.td}>Tijdstip van uw laatste aanmelding — een sessie zonder kristal-code verloopt na 24 uur.</td></tr>
