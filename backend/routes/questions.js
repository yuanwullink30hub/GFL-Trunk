  ...
  return [
    {
      ...
      createdAt: new Date(),
      questions: [
        { id: 1, text: 'Hoe bewaak je de grens tussen jouw rijke binnenwereld en de verwachtingen van de buitenwereld?', domain: 'introversie', answers: [
        ...
        { id: 2, text: 'Hoe navigeer je door sociale hiërarchieën en ongeschreven groepsregels?', domain: 'introversie', answers: [
        ...
        { id: 3, text: 'Wat is jouw natuurlijke rol in de sociale hiërarchie van een vriendengroep?', domain: 'introversie', answers: [
        ...
        { id: 4, text: 'Hoe draag je de \'belasting\' van de geschiedenis en voorouders met je mee?', domain: 'introversie', answers: [
        ...
        { id: 5, text: 'Wat is jouw fundamentele houding tegenover \'Tekort\' versus \'Overvloed\'?', domain: 'introversie', answers: [
        ...
        { id: 6, text: 'Wat doet het besef van sterfelijkheid en de dood met jouw levenshouding?', domain: 'introversie', answers: [
        ...
        { id: 7, text: 'Hoe ga je om met strikte morele regels, religie of dogma\'s uit je opvoeding?', domain: 'introversie', answers: [
        ...
        { id: 8, text: 'Waarom heb je behoefte aan momenten van stilte en afzondering?', domain: 'introversie', answers: [
        ...
        { id: 9, text: 'Welke invloed heeft je opvoeding op wie je nu bent?', domain: 'introversie', answers: [
        ...
        { id: 10, text: 'Hoe ervaar je de constante prikkels van de moderne wereld?', domain: 'introversie', answers: [
        ...
        { id: 11, text: 'Wat betekent het voor jou om een fout te maken?', domain: 'introversie', answers: [
        ...
        { id: 12, text: 'Hoe kijk je naar autoriteit en machtsverhoudingen?', domain: 'introversie', answers: [
    ...
    },
    {
      ...
      createdAt: new Date(),
      questions: [
        { id: 13, text: 'Hoe positioneer jij jezelf in een team dat onder hoge druk staat?', domain: 'extraversie', answers: [
        ...
        { id: 14, text: 'Hoe ga je om met felle concurrentie en rivaliteit in je vakgebied?', domain: 'extraversie', answers: [
        ...
        { id: 15, text: 'Wat doe je als je een kamer vol onbekenden binnenstapt op een netwerkevenement?', domain: 'extraversie', answers: [
        ...
        { id: 16, text: 'Wat is je primaire reactie op een groot zakelijk falen of een crisis?', domain: 'extraversie', answers: [
        ...
        { id: 17, text: 'Welke rol neem je in binnen een gemeenschap of vereniging?', domain: 'extraversie', answers: [
        ...
        { id: 18, text: 'Hoe creëer je waarde en impact in de buitenwereld?', domain: 'extraversie', answers: [
        ...
        { id: 19, text: 'Hoe neem je beslissingen als de belangen groot zijn en de uitkomst onzeker?', domain: 'extraversie', answers: [
        ...
        { id: 20, text: 'Wat is de diepere drijfveer achter jouw ambitie?', domain: 'extraversie', answers: [
        ...
        { id: 21, text: 'Hoe ga je om met kritiek en professionele grenzen?', domain: 'extraversie', answers: [
        ...
        { id: 22, text: 'Welk businessmodel is leidend voor je eigen zaak?', domain: 'extraversie', answers: [
        ...
        { id: 23, text: 'Wat kenmerkt jouw natuurlijke leiderschapsstijl?', domain: 'extraversie', answers: [
        ...
        { id: 24, text: 'Hoe ga je om met ethische dilemma\'s?', domain: 'extraversie', answers: [
    ...
    },
    {
      ...
      createdAt: new Date(),
      questions: [
        { id: 25, text: 'Hoe zoek jij naar \'waarheid\' in een tijd waarin media en algoritmes bepalen wat we zien?', domain: 'cultuur', answers: [
        ...
        { id: 26, text: 'Wat is jouw houding tegenover technologische revoluties die onze cultuur op zijn kop zetten?', domain: 'cultuur', answers: [
        ...
        { id: 27, text: 'Hoe kijk je naar veranderende idealen (zoals vrijheid van spreken) door de tijd heen?', domain: 'cultuur', answers: [
        ...
        { id: 28, text: 'Wat is de rol van tradities in een digitale wereld?', domain: 'cultuur', answers: [
        ...
        { id: 29, text: 'Hoe integreer jij AI in je eigen leven?', domain: 'cultuur', answers: [
        ...
        { id: 30, text: 'Hoe kijk je naar de macht van \'Big Tech\' over onze informatie?', domain: 'cultuur', answers: [
        ...
        { id: 31, text: 'Wat leert de geschiedenis ons over vooruitgang?', domain: 'cultuur', answers: [
        ...
        { id: 32, text: 'Hoe reageer je op sociale eenzaamheid door digitalisering?', domain: 'cultuur', answers: [
        ...
        { id: 33, text: 'Wat is de rol van persoonlijke creativiteit in deze tijd?', domain: 'cultuur', answers: [
        ...
        { id: 34, text: 'Hoe reageer je op de vraag om je levensstijl op te offeren voor een \'hoger doel\' (zoals klimaat)?', domain: 'cultuur', answers: [
        ...
        { id: 35, text: 'Hoe doorzie je machtsspelletjes in de cultuur?', domain: 'cultuur', answers: [
        ...
        { id: 36, text: 'Wat is de taak van de cultuur in een diverse wereld?', domain: 'cultuur', answers: [
    ...
    },
    {
      ...
      createdAt: new Date(),
      questions: [
        { id: 37, text: 'Hoe ga je in een relatie om met ongelijke behandeling?', domain: 'huwelijk', answers: [
        ...
        { id: 38, text: 'Hoe kijk je naar technologie die onze ziel beïnvloedt?', domain: 'huwelijk', answers: [
        ...
        { id: 39, text: 'Wat betekent muziek voor jouw persoonlijkheid?', domain: 'huwelijk', answers: [
        ...
        { id: 40, text: 'Wat is jouw ideaalbeeld van een huwelijk of partnerschap?', domain: 'huwelijk', answers: [
        ...
        { id: 41, text: 'Hoe zie jij de menselijke ziel?', domain: 'huwelijk', answers: [
        ...
        { id: 42, text: 'Hoe beïnvloedt jouw sociale klasse/achtergrond je relaties?', domain: 'huwelijk', answers: [
        ...
        { id: 43, text: 'Hoe ga je om met asymmetrie (ongelijkheid) in geven en nemen?', domain: 'huwelijk', answers: [
        ...
        { id: 44, text: 'Hoe belangrijk is biochemie (aantrekkingskracht) versus verstand bij partnerkeuze?', domain: 'huwelijk', answers: [
        ...
        { id: 45, text: 'Welke rol speelt competentie in jouw eigenwaarde?', domain: 'huwelijk', answers: [
        ...
        { id: 46, text: 'Hoe kijk je naar de \'ziel\' van je partner?', domain: 'huwelijk', answers: [
        ...
        { id: 47, text: 'Hoe belangrijk is een gedeelde culturele achtergrond?', domain: 'huwelijk', answers: [
        ...
        { id: 48, text: 'Sommige relaties zijn tijdelijk; wat betekenen deze in jouw verhaal?', domain: 'huwelijk', answers: [
    ...
    },
    {
      ...
      createdAt: new Date(),
      questions: [
        { id: 49, text: 'Wat ervaar je als je alleen in de overweldigende natuur bent?', domain: 'spiritualiteit', answers: [
        ...
        { id: 50, text: 'Is er een grens tussen technologie en magie?', domain: 'spiritualiteit', answers: [
        ...
        { id: 51, text: 'Hoe ga je om met de elementen (aarde, water, vuur, lucht)?', domain: 'spiritualiteit', answers: [
        ...
        { id: 52, text: 'Hoe verhoud jij je tot het \'Grote Mysterie\'?', domain: 'spiritualiteit', answers: [
        ...
        { id: 53, text: 'Wat betekent nederigheid voor jou?', domain: 'spiritualiteit', answers: [
        ...
        { id: 54, text: 'Hoe positioneer jij de mens in de natuurlijke hiërarchie?', domain: 'spiritualiteit', answers: [
        ...
        { id: 55, text: 'Hoe verklaar je wonderen of onverklaarbare toevalligheden?', domain: 'spiritualiteit', answers: [
        ...
        { id: 56, text: 'Hoe kijk je naar de dood?', domain: 'spiritualiteit', answers: [
        ...
        { id: 57, text: 'Hoe ervaar jij de leiding van jouw innerlijke kompas of spirituele intuïtie?', domain: 'spiritualiteit', answers: [
        ...
        { id: 58, text: 'Hoe ervaar jij de invloed van onzichtbare informatievelden op jouw leven?', domain: 'spiritualiteit', answers: [
        ...
        { id: 59, text: 'Hoe ga je om met de donkere kant van de natuur (rampen, ziekte)?', domain: 'spiritualiteit', answers: [
        ...
        { id: 60, text: 'Wat is de waarde van rituelen?', domain: 'spiritualiteit', answers: [
