...
export default {
  assessmentIntroExtra: {
    ...
    consent: {
      ...
      whatWeDoP2: {
        nl: 'Wij bewaren het volledig rapport tijdelijk op beveiligde servers in {b|Frankfurt}, uitsluitend ten behoeve van systeemevaluatie. De beheerder van Garden For Life heeft toegang via een beveiligd beheerderspaneel. Dit wordt geregistreerd in een auditlog.',
        en: 'We store the full report temporarily on secure servers in {b|Frankfurt}, solely for the purpose of system evaluation. The administrator of Garden For Life has access via a secured administrator panel. This is recorded in an audit log.',
      },
      checkboxTerms: {
      ...
      bullets: {
        nl: [
          ...
          'Het volledige rapport wordt tijdelijk opgeslagen uitsluitend ten behoeve van de systeemevaluatie — niet voor commerciële doeleinden',
          'De beheerder van Garden For Life toegang heeft tot opgeslagen rapporten en assessmentdata uitsluitend ten behoeve van systeemevaluatie en systeemverbetering — dit wordt bijgehouden in een beveiligd auditlog',
          'Alle rapportdata wordt uiterlijk op {a|27-09-2026} permanent en onherroepelijk verwijderd',
        ...
        en: [
          ...
          'The full report is stored temporarily solely for the purpose of system evaluation — not for commercial purposes',
          'The administrator of Garden For Life has access to stored reports and assessment data solely for the purpose of system evaluation and system improvement — this is recorded in a secured audit log',
          'All report data will be permanently and irrevocably deleted no later than {a|27-09-2026}',
