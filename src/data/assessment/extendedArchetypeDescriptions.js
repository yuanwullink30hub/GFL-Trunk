...
const EXTENDED_DESCRIPTIONS = {
  ...
  TRICKSTER_CHAOS: {
    ...
    harmony: true,
    combination: 'De Dwaas is de kosmische grappenmaker — de Nar versterkt door het Salience Network. Je dwaasheid is geen zwakte maar wijsheid in vermomming. De Fool weet dat het bestaan absurd is, en omarmt die absurditeit als bevrijding.',
    shadow: 'Spirituele humor kan nihilisme maskeren. De Sage herinnert je: de diepste grap bevat een kern van waarheid.',
  },
  TRICKSTER_ABSTRACT: {
    name: 'The Comedian',
    subtitle: 'Trickster + Abstract',
    harmony: false,
    combination: 'De Komiek combineert de speelsheid van de Nar met het inzicht van het Default Mode Network. Je ziet het absurde in het serieuze — en maakt het bespreekbaar. Humor is je filosofie.',
  ...
  TRICKSTER_AGENCY: {
    ...
    harmony: false,
    combination: 'De Saboteur is de Nar die handelt — chaos als strategie. De Agency-groep geeft de speelsheid slagkracht. Je bent de glitch in de matrix die het systeem wakker schudt.',
  ...
  TRICKSTER_RULING: {
    ...
    shadow: 'Macht via humor kan manipulatief worden. De Sage herinnert je: de ware hofnar dient de waarheid, niet zijn eigen positie.',
  },
  TRICKSTER_RELATIONAL: {
    name: 'The Clown',
    subtitle: 'Trickster + Relational',
    harmony: false,
    combination: 'De Clown verbindt mensen door humor. De Relational-groep richt de speelsheid van de Nar op menselijke relaties. Je maakt het leven lichter voor iedereen om je heen.',
  ...
  TRICKSTER_SEEKER: {
    ...
    harmony: false,
    combination: 'De Gedaantewisselaar combineert de vloeibaarheid van de Nar met de open nieuwsgierigheid van de Seeker-groep. Je bent nooit hetzelfde tweemaal — elke dag is een nieuwe versie van jezelf. Identiteit is je canvas.',
