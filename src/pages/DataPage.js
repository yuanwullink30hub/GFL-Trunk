...
/* ═══════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════ */
const PLANETS = [
  { id: 2, name: 'MOON', type: 'moon', size: 13.824, brightness: 1, cx: 'calc(92.29vw - 2rem)', cy: 'calc(13.74vh + 1rem + 3rem)', dur: 18, color: '156, 163, 175', tilt: 15, texture: 'radial-gradient(circle at 30% 30%, rgba(255,255,255,0.2) 0%, transparent 20%), radial-gradient(circle at 70% 60%, rgba(0,0,0,0.3) 0%, transparent 30%), radial-gradient(circle at 40% 70%, rgba(255,255,255,0.15) 0%, transparent 20%), linear-gradient(45deg, rgba(156,163,175,0.4) 0%, rgba(107,114,128,0.4) 100%)' },
  { id: 9, name: 'VENUS', type: 'venus', size: 17.28, cx: '72.28vw', cy: 'calc(9.36vh + 3rem)', dur: 16, color: '217, 119, 6', tilt: 25, behindNebula: true, brightness: 0.9, texture: 'radial-gradient(circle at 30% 30%, rgba(245,158,11,0.4) 0%, rgba(180,83,9,0.3) 30%, transparent 60%), radial-gradient(circle at 70% 70%, rgba(120,53,15,0.4) 0%, rgba(180,83,9,0.3) 40%, transparent 70%), linear-gradient(45deg, rgba(217,119,6,0.4) 0%, rgba(253,230,138,0.3) 50%, rgba(217,119,6,0.4) 100%)' },
  { id: 3, name: 'MARS', type: 'mars', size: 15.552, cx: '89.02vw', cy: 'calc(52.04vh + 3rem)', dur: 14, color: '234, 88, 12', tilt: 25, brightness: 1, texture: 'radial-gradient(circle at 30% 40%, rgba(234,88,12,0.4) 0%, transparent 50%), radial-gradient(circle at 70% 60%, rgba(67,20,7,0.3) 0%, transparent 60%), linear-gradient(to bottom right, rgba(153,27,27,0.4) 0%, rgba(194,65,12,0.4) 50%, rgba(127,29,29,0.4) 100%)' },
  { id: 11, name: 'MERCURY', type: 'mercury', size: 12.096, cx: '64.13vw', cy: 'calc(30.05vh + 3rem)', dur: 20, color: '163, 163, 163', tilt: 2, behindNebula: true, brightness: 1, texture: 'radial-gradient(circle at 40% 40%, rgba(255,255,255,0.2) 0%, transparent 30%), radial-gradient(circle at 60% 60%, rgba(0,0,0,0.3) 0%, transparent 40%), linear-gradient(45deg, rgba(163,163,163,0.4) 0%, rgba(115,115,115,0.4) 100%)' },
  { id: 1, name: 'SUN', type: 'sun', size: 38.016, cx: '46.69vw', cy: '24.20vh', dur: 25, color: '250, 204, 21', tilt: 7, brightness: 1.32, texture: 'radial-gradient(circle at 50% 50%, rgba(254,252,232,0.5) 0%, rgba(250,204,21,0.4) 40%, rgba(234,88,12,0.3) 80%, rgba(153,27,27,0.2) 100%)' },
  { id: 4, name: 'JUPITER', type: 'jupiter', size: 38.1888, cx: 'calc(57.49vw + 2rem)', cy: 'calc(69.97vh + 1rem)', dur: 28, color: '245, 158, 11', tilt: 3, behindNebula: true, brightness: 1, texture: 'radial-gradient(ellipse 15% 10% at 60% 65%, rgba(180,50,20,0.5) 0%, rgba(140,30,10,0.3) 50%, transparent 100%), radial-gradient(ellipse 10% 5% at 30% 48%, rgba(255,240,220,0.4) 0%, transparent 100%), radial-gradient(ellipse 20% 6% at 75% 30%, rgba(160,100,60,0.3) 0%, transparent 100%), radial-gradient(ellipse 12% 8% at 20% 80%, rgba(240,230,210,0.3) 0%, transparent 100%), radial-gradient(ellipse 25% 5% at 85% 52%, rgba(80,30,5,0.3) 0%, transparent 100%), repeating-linear-gradient(to right, transparent 0%, rgba(0,0,0,0.05) 2%, transparent 4%), linear-gradient(to bottom, rgba(120,110,100,0.4) 0%, rgba(200,190,180,0.5) 20%, rgba(230,220,200,0.5) 35%, rgba(100,40,10,0.5) 45%, rgba(130,60,20,0.5) 55%, rgba(220,200,170,0.5) 65%, rgba(180,130,90,0.5) 80%, rgba(120,110,100,0.4) 100%)' },
  { id: 6, name: 'SATURN', type: 'saturn', size: 24.192, cx: '31.20vw', cy: '50.84vh', dur: 22, color: '253, 230, 138', tilt: 26, hasRing: true, behindNebula: true, brightness: 0.9, texture: 'repeating-linear-gradient(to right, transparent 0%, rgba(0,0,0,0.03) 3%, transparent 6%), linear-gradient(to bottom, rgba(214,211,209,0.4) 0%, rgba(253,230,138,0.5) 25%, rgba(234,179,8,0.3) 45%, rgba(253,230,138,0.5) 65%, rgba(147,197,253,0.4) 90%, rgba(100,116,139,0.4) 100%)' },
  { id: 10, name: 'URANUS', type: 'uranus', size: 21.28896, cx: 'calc(9.24vw + 1rem)', cy: 'calc(40.45vh - 2rem)', dur: 20, color: '37, 99, 235', tilt: 98, behindNebula: true, brightness: 0.9, texture: 'radial-gradient(circle at 20% 30%, rgba(255,255,255,0.3) 0%, transparent 5%), radial-gradient(circle at 70% 60%, rgba(255,255,255,0.2) 0%, transparent 4%), repeating-linear-gradient(to right, transparent 0%, rgba(255,255,255,0.03) 2%, transparent 5%), linear-gradient(to bottom, rgba(15,32,39,0.5) 0%, rgba(44,83,100,0.5) 20%, rgba(147,197,253,0.4) 30%, rgba(30,58,138,0.5) 40%, rgba(147,197,253,0.3) 60%, rgba(15,32,39,0.5) 80%, rgba(30,58,138,0.4) 100%)' },
  { id: 7, name: 'NEPTUNE', type: 'neptune', size: 19.44, cx: 'calc(16.03vw + 1rem)', cy: '83.20vh', dur: 18, color: '56, 189, 248', tilt: 97, brightness: 1, texture: 'linear-gradient(to bottom, rgba(255,255,255,0.2) 0%, rgba(186,230,253,0.4) 20%, rgba(56,189,248,0.3) 50%, rgba(14,165,233,0.4) 80%, rgba(2,132,197,0.5) 100%)' },
];
...
const HologramPlanet = memo(({ p, isZoomed, isZoomedIn, hideOriginal, onClick }) => {
  return (
    ...
    >
      ...
      {/* Label */}
      <div style={{ position: 'absolute', bottom: '-3rem', display: 'flex', flexDirection: 'column', alignItems: 'center', color: `rgba(${p.color}, 0.9)`, textShadow: `0 0 8px rgba(${p.color}, 0.8)` }}>
        <div style={{ fontSize: 'max(8px, 0.55vw)', textTransform: 'uppercase', letterSpacing: '0.4em', fontFamily: "'Lexend Mega', monospace", fontWeight: 'bold', whiteSpace: 'nowrap' }}>{p.name}</div>
