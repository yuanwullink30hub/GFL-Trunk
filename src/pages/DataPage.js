...
const PLANETS = [
  ...
  { id: 7, name: 'NEPTUNE', type: 'neptune', size: 19.44, cx: 'calc(16.03vw + 1rem)', cy: '83.20vh', dur: 18, color: '56, 189, 248', tilt: 24, brightness: 1, texture: 'linear-gradient(to bottom, rgba(255,255,255,0.2) 0%, rgba(186,230,253,0.4) 20%, rgba(56,189,248,0.3) 50%, rgba(14,165,233,0.4) 80%, rgba(2,132,197,0.5) 100%)' },
];
