...
export const BRANDS = [
  ...
  // Placeholder brands 5-12 for future expansion
  {
    ...
    description: 'Leading the industry in sector E development. Our primary focus is on the integration of biological and mechanical systems to produce superior exploration solutions.',
    foundedYear: '2024',
    origin: 'Amsterdam',
    ...
    featuredProducts: [
      { id: 'p1', name: 'Mk.5 Alpha', price: 'Ξ 0.9', specs: ['Mil-Spec', 'Proto'] },
      { id: 'p2', name: 'Mk.5 Beta', price: 'Ξ 1.2', specs: ['Civ-Grade', 'Stable'] },
    ],
    events: [
    ...
    reviews: [
      { id: 'r1', user: 'User_Alpha', rating: 5, comment: 'Exceptional build quality.' },
      { id: 'r2', user: 'Anon_77', rating: 4, comment: 'Good performance.' },
    ],
    tags: ['Tech', 'Future', 'Innovation'],
    email: 'contact@sector-e.net',
    socialLinks: [
      { platform: 'web', url: '#' },
      { platform: 'insta', url: '#' },
      { platform: 'linkedin', url: '#' },
