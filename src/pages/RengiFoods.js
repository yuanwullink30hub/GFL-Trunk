    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img src={rengiLogo} alt="Rengi Foods" style={{ width: '100%', height: '100%', objectFit: 'cover', transform: 'scale(1.32)' }} />
        </div>
        ...
        <p style={{
          ...
          Rengi Foods captures the vibrant spirit of Korean street food, offering authentic and affordable flavors from Seoul's streets to your local market. The focus on affordability ensures everyone can enjoy bold Korean tastes without compromise.
        </p>
