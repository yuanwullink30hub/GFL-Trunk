...
const layer3Questions = [
  ...
  // ─── Q20 (Key 2, Standard) ───
  {
    ...
    answers: [
      ...
      ans(20, 3, 'Ambitie? Die heb ik — maar ik maak het altijd {ORANGE>serieus} met {ORANGE>een draai}. {ORANGE>Het doel bereiken} én het {ORANGE>licht houden} — die balans navigeer ik bewust.'),
  ...
  // ─── Q21 (Key 3, Mirror) ───
  {
    ...
    domain: 'massa',
    answers: [
      ans(21, 0, 'Het {ORANGE>voelt ongemakkelijk}. Ik {ORANGE>merk dat ik} het {ORANGE>meteen doorgeef} — die reflex vervult een functie die ik ken.'),
      ...
      ans(21, 2, 'Het {ORANGE>raakt me oprecht} — maar ik {ORANGE>betrap mezelf} erop dat ik het {ORANGE>nodig heb als bevestiging}. Die {ORANGE>afhankelijkheid} zie ik scherp.'),
      ans(21, 3, 'Meestal {PURPLE>verkeerd gericht}. Ze {PURPLE>erkennen het resultaat}. Niet het proces. {PURPLE>Het deel dat ertoe deed is onzichtbaar} — en dat is oké.'),
      ans(21, 4, 'Erkenning {ORANGE>weeg ik aan de bron}. Niet {ORANGE>elke stem telt gelijk} — dat is {ORANGE>een selectie die ik bewust hanteer}.'),
  ...
  // ─── Q24 (Key 6, Standard) ───
  {
    ...
    domain: 'massa',
    answers: [
      ans(24, 0, 'Als ze {PURPLE>leiden vanuit positie} en niet {PURPLE>vanuit waarheid}. Dan voelt het als {PURPLE>bedrog} — mijn {PURPLE>lijf verzet zich voor mijn hoofd het registreert}.'),
      ans(24, 1, 'Als ze {ORANGE>niet snappen waarom ze leiden}. {ORANGE>Leiderschap zonder zelfkennis is gevaarlijk} — die inschatting werkt bij mij als automatische scan.'),
      ...
      ans(24, 3, 'Als ze de {ORANGE>situatie niet lezen}. Ik zie de {ORANGE>hefbomen die ze missen} — dat {ORANGE>ongeduld} werkt als motor, maar ik betrap mezelf erop dat het niet altijd fair is.'),
...
const layer4Questions = [
  ...
  // ─── Q29 (Key 5, Standard) ───
  {
    ...
    answers: [
      ...
      ans(29, 4, 'Dat {PURPLE>zorgen niet altijd helpt}. {PURPLE>Soms is de beste zorg afstand} — en dat voelt als verraad aan alles wat ik ben.'),
