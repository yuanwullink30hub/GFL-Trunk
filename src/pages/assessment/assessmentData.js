...
const layer1Questions = [
  ...
  // ─── Q2 (Key 2, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(2, 0, 'Ik {ORANGE>scan} meteen wat er nu {ORANGE>mogelijk is}. Want een overtuiging die valt maakt altijd meer ruimte vrij dan ze innam \u2014 die dynamiek herken ik als mijn eigen operating system.'),
      ans(2, 1, 'Het voelt alsof er iets {PURPLE>scheurt}. Niet in mijn hoofd \u2014 {PURPLE>dieper}. Dat gat moet ik eerst voelen voordat ik er iets mee kan.'),
      ans(2, 2, 'Ik {ORANGE>ga na} welke beslissingen op die overtuiging rustten. Want als het {ORANGE>fundament} niet klopt, wil ik weten wat er nog overeind staat voordat ik verder bouw.'),
      ans(2, 3, 'Eerlijk gezegd vind ik het {PURPLE>grappig} \u2014 dat ik er zo lang in trapte. Geloven is sowieso een tijdelijk contract.'),
      ans(2, 4, 'Mijn eerste gedachte gaat naar de {ORANGE>mensen} met wie ik {ORANGE>dit deelde}. Inmiddels herken ik dat patroon \u2014 eerst zij, dan pas ik.'),
      ans(2, 5, 'Ik word wakker. Alsof er een laag wegvalt en ik {PURPLE>scherper} zie. Een {PURPLE>illusie minder} is een hefboom meer.'),
    ],
  },
  ...
  // ─── Q4 (Key 4, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(4, 0, 'Als ik functioneer {ORANGE>in plaats van voel}. Ik betrap mezelf op het moment dat het kantelt \u2014 het is hoe ik overleef, niet hoe ik leef.'),
      ans(4, 1, 'Als het {PURPLE>chaos} is en ik er {PURPLE>niks aan kan doen}. Niet andermans chaos \u2014 die van mijzelf. Dat is geen ongemak, dat is alarm.'),
      ans(4, 2, 'Als ik te {ORANGE>lang op dezelfde plek} zit. Door de tijd heen is dat mijn betrouwbaarste waarschuwing geworden \u2014 herhaling is mijn signaal dat ik vastzit.'),
      ans(4, 3, 'Als ik niks heb om voor te vechten. {PURPLE>Geen doel}, geen weerstand. Die leegte is het engste \u2014 alsof ik zonder strijd verdamp.'),
      ans(4, 4, '{ORANGE>Als ik meedoe} aan iets waar ik niet achter sta. Want elke dag dat ik mijn mond hou, merk ik dat er iets in me stilvalt.'),
      ans(4, 5, 'Als ik {PURPLE>niet meer kan denken}. Niet vermoeidheid \u2014 ruis. Te veel prikkels, te weinig stilte. Dan verlies ik het signaal.'),
    ],
  },
  ...
  // ─── Q6 (Key 6, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(6, 0, '{ORANGE>"Het maakt niet uit wat ik vind."} Want zodra ik dat geloofde, ging ik meedoen met dingen die niet klopten \u2014 en het stilzwijgen bleek de werkelijke schade.'),
      ans(6, 1, '{PURPLE>"Ik snap het."} Terwijl ik het helemaal niet snapte \u2014 ik had alleen een model dat klopte. Het gevaarlijkste moment is wanneer begrip aanvoelt als controle.'),
      ans(6, 2, '{ORANGE>"Ze hebben me nodig."} Dat klonk als liefde, maar het deed dienst als ketting. Zolang ik onmisbaar was, hoefde ik niet naar mezelf te kijken.'),
      ans(6, 3, '{PURPLE>"Ik kan dit fixen."} Alles. Altijd. Het gevaarlijke is niet de arrogantie \u2014 het is dat het vaak klopt. En juist omdat het klopt, stopte ik met vragen of ik het ook m\u00f3est.'),
      ans(6, 4, '{ORANGE>"Ik hoef nergens bij te horen."} Want dat voelde als vrijheid, maar het functioneerde als verdedigingslinie. Achter die linie werd het steeds stiller.'),
      ans(6, 5, '{PURPLE>"Als ik het niet doe, doet niemand het."} En het klopt \u2014 meestal. Maar die overtuiging vult elke ruimte. Er blijft niks over voor de twijfel, de rust, het loslaten.'),
    ],
  },
  ...
  // ─── Q7 (Key 1, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(7, 0, 'Toen ik merkte dat {ORANGE>mijn strengheid} naar anderen een omweg was om mezelf niet aan te kijken. Dat inzicht bouwde zich over maanden op.'),
      ans(7, 1, 'Dat ik {PURPLE>grappen maak als het pijn doet}. Niet als strategie \u2014 het gebeurt gewoon. De lach zit er eerder dan de traan, en ik weet niet of dat kracht is of een reflex waar ik niks aan kan doen.'),
      ans(7, 2, 'Dat ik soms {ORANGE>geef om te krijgen}. Die ontdekking ondermijnt het verhaal dat ik mijn warmte onvoorwaardelijk deel.'),
      ans(7, 3, 'Dat ik meer weet dan ik durf toe te passen. De {PURPLE>kennis is er}, het inzicht is er \u2014 maar de moed om {PURPLE>ernaar te handelen blijft achter}.'),
      ans(7, 4, 'Dat mijn {ORANGE>optimisme soms als schild werkt}, er zijn momenten waarop ik het positieve opzoek niet omdat ik erin geloof, maar omdat het alternatief te zwaar voelt.'),
      ans(7, 5, 'Dat ik niet stop omdat ik gedreven ben, maar omdat ik {PURPLE>bang} ben voor wat er overblijft {PURPLE>als ik stilsta}. Die motor draait altijd \u2014 en ik weet niet hoe het voelt als hij stopt.'),
    ],
  },
  ...
  // ─── Q8 (Key 2, Standard) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(8, 0, 'Dat ik nergens helemaal land. Mensen, plekken, projecten \u2014 ik ben er altijd net niet helemaal. De vrijheid die dat oplevert is dezelfde {PURPLE>vrijheid die me eenzaam maakt}.'),
  ...
  // ─── Q9 (Key 3, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(9, 0, 'De drang om iets {ORANGE>voor iemand te betekenen}. Zelfs zonder al het andere blijf ik overeind zolang er iemand is die me nodig heeft. Ik betrap mezelf erop dat dat mooi klinkt \u00e9n een val is.'),
      ans(9, 1, 'De weigering om te stoppen. Alles kan weg \u2014 als die {PURPLE>motor maar blijft draaien}. Het is geen keuze, het is wat er overblijft als al het andere stilvalt.'),
      ans(9, 2, 'De {ORANGE>overtuiging dat het weer goed komt}. Niet blind \u2014 ik heb genoeg meegemaakt om te weten dat hoop geen garantie is \u2014 dus kies ik er bewust voor.'),
      ans(9, 3, 'De binnenkant. Alles wat ik van buiten opbouwde is een vertaling \u2014 {PURPLE>het origineel zit in mij}. Dat kan niemand afpakken, niet omdat ik het bescherm, maar omdat het nergens anders bestaat.'),
      ans(9, 4, '{ORANGE>Mijn code}. Want alles wat ik bezat was gebouwd op een fundament van principes. Als het gebouw instort, toets ik wat overblijft aan datzelfde fundament \u2014 die procedure is mijn kompas.'),
      ans(9, 5, '{PURPLE>De lach}. Serieus. Neem alles weg en ik zit in een leeg veld en vind het grappig. Niet cynisch \u2014 \u00e9cht grappig. En in die absurditeit zit iets onverwoestbaars.'),
    ],
  },
];
...
const layer2Questions = [
  // ─── Q10 (Key 4, Standard) ───
  {
    ...
    answers: [
      ...
      ans(10, 4, 'Of ze echt zijn. {PURPLE>Niet beleefd, eerlijk, echt}. Ik ruik aanpassing van kilometers. Vroeger stootte het me af. Nu lees ik het.'),
  ...
  // ─── Q11 (Key 5, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(11, 0, '{ORANGE>Bewust cynisch}. De keuze om niet te geloven terwijl vertrouwen mogelijk is. Die keuze begrijp ik — verdragen kost me nog steeds moeite.'),
      ans(11, 1, 'Als iemand {PURPLE>vastloopt terwijl de deur al open staat}. Ik zie de opening die zij niet zien — en dat verschil frustreert me fysiek, op een manier die ik niet kan uitleggen.'),
      ans(11, 2, 'Als iemand {ORANGE>liegt en denkt dat ik het niet doorheb}. Niet de leugen irriteert me — het gebrek aan respect dat erachter zit. Die ontleding heb ik scherp.'),
      ans(11, 3, 'Als iemand {PURPLE>chaos veroorzaakt die te voorkomen was}. Als iets dat ik vertrouw begint te schuiven door nalatigheid — dat voelt niet als ergernis maar als alarm.'),
      ans(11, 4, '{ORANGE>Opzettelijke wreedheid}. Dat is het enige moment waarop mijn geduld opraakt — en ik merk dat mijn reactie dan feller is dan de situatie vraagt.'),
      ans(11, 5, 'Als {PURPLE>iemand oppervlakkig is en het niet eens merkt}. Niet oppervlakkig als keuze — maar als staat. Die platte blik op de wereld maakt iets in me dicht.'),
    ],
  },
  ...
  // ─── Q13 (Key 1, Mirror) ───
  {
    ...
    answers: [
      ...
      ans(13, 1, 'Aan of ze kunnen lachen om zichzelf. Wie dat kan, draagt geen masker. {ORANGE>Zelfspot is mijn betrouwbaarste detector}.'),
  ...
  // ─── Q14 (Key 2, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(14, 0, 'Dat mijn vertrek niet over hen gaat. Mensen lezen mijn behoefte aan {ORANGE>ruimte als afwijzing} — terwijl het precies het tegenovergestelde doet: het houdt me beschikbaar.'),
      ans(14, 1, '{PURPLE>Hoeveel ik waarneem}. Ze denken dat ik in mijn eigen wereld zit — maar ik zie alles. Elk detail, elke verschuiving. Ik reageer er alleen niet op.'),
      ans(14, 2, '{ORANGE>Dat mijn strengheid zorg is}. Het ziet eruit als afstand— maar de rol die ik daarin speel is die van iemand die wil dat mensen hun beste versie zijn.'),
      ans(14, 3, '{PURPLE>Hoe serieus het er vanbinnen aan toe gaat}. Ze zien de grap. Niet de pijn die eronder zit. En eerlijk gezegd is dat ook de bedoeling.'),
      ans(14, 4, '{ORANGE>Dat mijn warmte me moeite kost}. Mensen denken dat het vanzelf gaat — maar elke keer dat ik geef, gaat er iets af. Die energiebalans hou ik stil.'),
      ans(14, 5, '{PURPLE>Dat ik altijd drie stappen verder ben}. Wat eruitziet als geduld is eigenlijk wachten tot zij inhalen. Dat zien ze niet — ze denken dat ik naast ze loop.'),
    ],
  },
  ...
  // ─── Q15 (Key 3, Standard) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(15, 0, 'Veiligheid. {PURPLE>Niet een plek — een gevoel}. Ik creëer het om mensen heen zonder erbij na te denken — zonder oordeel, zonder agenda. Dat stroomt vanzelf.'),
      ...
      ans(15, 3, 'Aandacht. Ik zie {ORANGE>nuances in mensen die ze zelf nog niet zien}. Over de jaren is dat mijn scherpste gave geworden — maar het vreet veel energie.'),
  ...
  // ─── Q16 (Key 4, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(16, 0, 'Als ik {ORANGE>meer aandacht investeer dan er terugkomt}. Ik zie mezelf dat kantelpunt naderen — het punt waarop verbinding overgaat in eenrichtingsverkeer.'),
      ans(16, 1, 'Als iemand {PURPLE>bewust mijn principes ondermijnt}. Dan gaat er een deur dicht waar ik niet over onderhandel.'),
      ans(16, 2, 'Als het voorspelbaar wordt. Ik {ORANGE>vertrek} niet uit boosheid maar {ORANGE>uit verveling} — en dat laatste doet meer schade dan ik lang dacht.'),
      ans(16, 3, 'Als iemand {PURPLE>weigert voor zichzelf te vechten}. Ik kan lang meevechten, maar op het moment dat zij stoppen, stopt er iets in mij.'),
      ans(16, 4, 'Als de {ORANGE>oneerlijkheid groter wordt dan wat ons verbindt}. Want zodra we die grens over zijn, ben ik weg zonder waarschuwing \u2014 die lijn ken ik precies'),
      ans(16, 5, '{PURPLE>Als gesprekken circulair worden}. Dezelfde patronen, dezelfde blinde vlekken. Dan droogt mijn interesse op als water voor de zon.'),
    ],
  },
  ...
  // ─── Q17 (Key 5, Standard) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(17, 0, '{PURPLE>Dat ze het niet kapotmaken}. Niet beschermen — gewoon niet kapotmaken. Ik kan tegen tegenslag, maar tegen bewuste vergiftiging van iets dat goed is heb ik geen verdediging.'),
      ans(17, 1, 'Dat ze {ORANGE>me laten} werken {ORANGE>zonde}r het te hoeven {ORANGE>uitleggen}. Het verantwoorden van processen die ik zelf nog aan het ontdekken ben — dat remt me meer dan welke tegenslag ook.'),
      ans(17, 2, 'Dat ze er nog zijn nadat ik alles heb gezegd. {PURPLE>Ik spreek me altijd uit} — dat is niet het probleem. Het probleem is de stilte erna.'),
      ans(17, 3, 'Dat iemand {ORANGE>een keer de regie overneemt}. Maar de rol van degene die het nooit vraagt, speelt zichzelf voort.'),
      ans(17, 4, 'Dat iemand {PURPLE>ziet dat ik moe ben} zonder dat ik het hoef te laten zien. Dat verlangen zit in mijn botten — het is te groot om in woorden te passen.'),
      ans(17, 5, 'Dat ze me {ORANGE>niet vragen} het uit te leggen. De vraag {ORANGE>\'waarom?\'} vernietigt precies datgene wat ik probeer te delen \u2014 die dynamiek doorzie ik scherp.'),
    ],
  },
  ...
  // ─── Q18 (Key 6, Mirror) ───
  {
    ...
    domain: 'introversie',
    answers: [
      ans(18, 0, '{ORANGE>Meeloperij}. Ik veroordeel mensen die meedoen met systemen die niet kloppen. Maar ik betrap mezelf erop dat die woede dubbelzijdig is — de momenten waarop ik zelf zweeg, branden het hardst.'),
      ans(18, 1, '{PURPLE>Onverschilligheid voor diepte}. Als iemand niet nadenkt, voel ik iets dat lijkt op walging. Alsof ze bewust de deur dichtdoen naar iets dat voor mij alles is.'),
      ans(18, 2, '{ORANGE>Egoïsme}. Als iemand voor zichzelf kiest, voel ik iets scherps. Die scherpte werkt als spiegel — ik gun hen wat ik mezelf niet geef.'),
      ans(18, 3, '{PURPLE>Passiviteit}. Als iemand lijdt aan iets dat op te lossen is en het niet doet — mijn handen jeuken. Het is fysiek. Alsof hun stilstand mij persoonlijk raakt.'),
      ans(18, 4, '{ORANGE>Vastklampen}. Als iemand vasthoudt aan wat was, voel ik ongeduld. Die irritatie herken ik als mijn eigen angst — de angst dat ik zelf ooit zo vast kom te zitten.'),
      ans(18, 5, '{PURPLE>Zwakte}. Als iemand de controle verliest, voel ik geen medelijden — ik voel ongemak. Alsof hun chaos besmettelijk is en ik er afstand van moet nemen.'),
    ],
  },
];
...
const layer3Questions = [
  // ─── Q19 (Key 1, Mirror) ───
  {
    ...
    domain: 'massa',
    answers: [
      ans(19, 0, 'De standaard stijgt. Ik merk dat {ORANGE>mensen scherper worden} — en die functie vervul ik bewust.'),
      ans(19, 1, 'Het wordt {PURPLE>sfeervoller}. Niet door mij — het is alsof de spanning zakt zodra ik er ben. Ik zeg niks, het is er gewoon.'),
      ...
      ans(19, 5, '{PURPLE>Mensen gaan op aan}. Niet richting mij — maar alsof ze plots iets hebben besloten. Die verwachting hang ik niet op, die is er.'),
    ],
  },
  ...
  // ─── Q20 (Key 2, Standard) ───
  {
    ...
    domain: 'massa',
    answers: [
      ans(20, 0, 'Ambitie is richting, niet bestemming. Het doel staat vast of niet — {PURPLE>Het IS de zoektocht}.'),
      ans(20, 1, '{ORANGE>Ambitie dient als brandstof}, maar zodra het het werk gaat sturen in plaats van voeden, merk ik dat het me leegtrekt.'),
      ...
      ans(20, 4, 'Ambitie voelt alleen echt {PURPLE>als het iemand raakt}. Bereiken voor mezelf is hol — het moet landen bij een ander.'),
      ans(20, 5, '{ORANGE>Ambitie werkt bij mij als hefboom} — niet het doel zelf, maar wat ik ermee kan transformeren. Die mechanica doorzie ik scherp.'),
    ],
  },
  ...
  // ─── Q21 (Key 3, Mirror) ───
  {
    ...
    answers: [
      ...
      ans(21, 1, '{PURPLE>Ik neem het aan en ga door}. Niet uit bescheidenheid — er is gewoon altijd een volgend ding. Stilstaan bij erkenning voelt als remmen.'),
      ans(21, 2, 'Het {ORANGE>raakt me oprecht} — maar ik betrap mezelf erop dat ik het nodig heb als bevestiging. Die afhankelijkheid zie ik scherp.'),
      ...
      ans(21, 4, 'Erkenning {ORANGE>weeg ik aan de bron}. Niet elke stem telt gelijk — dat is een selectie die ik bewust hanteer.'),
      ans(21, 5, '{PURPLE>Ik lach het weg}. Niet om het af te wijzen — het is meer dat het serieus nemen ervan iets breekt. Erkenning is het grappigste compliment.'),
    ],
  },
  ...
  // ─── Q22 (Key 4, Standard) ───
  {
    ...
    answers: [
      ...
      ans(22, 1, '{ORANGE>Structuur houden}. De systemen draaien of er publiek is of niet — maar ik merk dat de scherpte daalt als er niemand meekijkt. Die val ken ik.'),
      ans(22, 2, 'Dan pas beweeg ik echt. Zonder kijkers verdwijnt de richting en {PURPLE>begint het ontdekken}. Dat is waar ik het scherpst ben.'),
      ans(22, 3, 'Minder. Ik betrap mezelf erop dat {ORANGE>de motor zachter draait} als er niemand leunt. Die afhankelijkheid van een publiek — die rol doorzie ik.'),
      ans(22, 4, 'Precies hetzelfde. Publiek verandert niks — mijn {PURPLE>kompas draait niet op goedkeuring}. Het is het enige dat ik vertrouw.'),
      ans(22, 5, '{ORANGE>Dan denk ik het helderst}. Zonder input van buitenaf werkt mijn hoofd als schoonste instrument. Dat verschil herken ik als mijn kwetsbaarheid.'),
    ],
  },
  ...
  // ─── Q23 (Key 5, Mirror) ───
  {
    ...
    domain: 'massa',
    answers: [
      ans(23, 0, 'Als meer de {ORANGE>zuiverheid} van wat er {ORANGE>is bedreigt}. Die grens herken ik als mijn beschermingsmechanisme — niet alles wat groeit wordt beter.'),
      ...
      ans(23, 3, 'Als de {PURPLE>complexiteit de architectuur overstijgt}. Chaos is mijn grondstof, maar als patronen vervagen verliest de constructie haar fundament.'),
  ...
  // ─── Q24 (Key 6, Standard) ───
  {
    ...
    domain: 'massa',
    answers: [
      ans(24, 0, 'Als ze {PURPLE>leiden vanuit positie en niet vanuit waarheid}. Dan voelt het als bedrog — mijn lijf verzet zich voor mijn hoofd het registreert.'),
      ans(24, 1, 'Als ze {ORANGE>niet snappen waarom ze leiden}. Leiderschap zonder zelfkennis is gevaarlijk — die inschatting werkt bij mij als automatische scan.'),
      ...
      ans(24, 3, 'Als ze de {ORANGE>situatie niet lezen}. Ik zie de hefbomen die ze missen — dat ongeduld werkt als motor, maar ik betrap mezelf erop dat het niet altijd fair is.'),
      ...
      ans(24, 5, 'Als ze {ORANGE>slordiger zijn dan ik} zou zijn. Die vergelijking maak ik automatisch — en ik doorzie dat dat meer over mijn standaard zegt dan over hun leiderschap.'),
    ],
  },
];
...
const layer4Questions = [
  // ─── Q25 (Key 1, Standard) ───
  {
    ...
    domain: 'wijsheid',
    answers: [
      ans(25, 0, 'Als de ander er niet klaar voor is. Ik voel dat — niet als {PURPLE>oordeel} maar {PURPLE>als timing}.'),

      ans(25, 1, 'Als het deelmoment de {ORANGE>vibe zou doden}. Ik doorzie dat timing meer doet dan inhoud — die mechanica zet ik bewust in.'),
      ans(25, 2, 'Als het de ander zou raken op een plek die {PURPLE>nog niet geheeld} is. Dat voel ik sneller dan ik het kan uitleggen.'),
      ans(25, 3, 'Als het ontvangen van de kennis {ORANGE>meer schade} zou doen {ORANGE>dan het niet-weten}. Deze afweging is mijn handvat.'),
      ans(25, 4, 'Als het iemands {PURPLE>vertrouwen zou breken}. Kennis die het licht uitdoet, hou ik vast. Dat is geen keuze — dat is bescherming.'),
      ans(25, 5, 'Als het de {ORANGE>actie zou vertragen}. Kennis die verlamt in plaats van activeert — die selectie maak ik automatisch, en ik merk dat het soms meer filtert dan nodig.'),
    ],
  },
  ...
  // ─── Q27 (Key 3, Standard) ───
  {
    ...
    domain: 'wijsheid',
    answers: [
      ans(27, 0, 'De overtuiging dat ik onmisbaar ben. {PURPLE>Niet iedereen had mij nodig} — sommigen hadden nodig dat ik losliet.'),
      ans(27, 1, 'De overtuiging {ORANGE>dat rust zwakte is}. Die gelijkstelling kost me tot op de dag van vandaag moeite — maar de rol van degene die nooit stopt, speel ik niet meer.'),
      ...
      ans(27, 3, 'De overtuiging {ORANGE>dat het perfect moet zijn}. Het ruwe werkt beter — die ontdekking functioneert als mijn grootste bevrijding.'),
      ans(27, 4, 'De overtuiging {PURPLE>dat ik altijd gelijk heb}. Het kompas klopt — maar niet elke richting is de mijne om te bewandelen.'),
      ans(27, 5, 'De overtuiging {ORANGE>dat lichtheid alles oplost}. Sommige dingen moeten zwaar zijn — die conditie heb ik leren herkennen: zodra de grap het gevoel vervangt, werkt het tegen me.'),
    ],
  },
  ...
  // ─── Q28 (Key 4, Mirror) ───
  {
    ...
    answers: [
      ...
      ans(28, 3, 'Wie er moeite heeft maar het niet laat zien. {PURPLE>Die stille strijd} — ik herken het direct. Alsof ik het gewicht voel dat zij dragen.'),
  ...
  // ─── Q30 (Key 6, Mirror) ───
  {
    ...
    domain: 'wijsheid',
    answers: [
      ans(30, 0, 'Dat {ORANGE>verandering niet} komt {ORANGE>van} de mensen die het {ORANGE>hardst schreeuwen}. Die les werkt als mijn strengste correctie — ik betrap mezelf erop dat ik het nog steeds vergeet.'),
      ...
      ans(30, 2, 'Dat {ORANGE>zorgen} pas werkt als het {ORANGE>niet om mij gaat}. Die dubbelheid doorzie ik scherp — het zuiverste geven is waar ik er niet meer in voorkom.'),
...
const layer5Questions = [
  // ─── Q31 (Key 1, Mirror) ───
  {
    ...
    answers: [
      ...
      ans(31, 3, 'Honger. {PURPLE>Diepere honger}. Het onkenbare is geen muur — het is een deur die harder trekt dan elk antwoord.'),
      ans(31, 4, '{ORANGE>Vertrouwen}. Niet alles hoeft begrepen te worden. Die overgave werkt als mijn stilste kracht.'),
      ans(31, 5, '{PURPLE>Onrust}. Mijn handen willen iets vast pakken — en er is niks. Dat is de onzekerste leegte.'),
    ],
  },
  ...
  // ─── Q32 (Key 2, Standard) ───
  {
    ...
    domain: 'mysterie',
    answers: [
      ans(32, 0, 'Dat wat ik nog niet heb gezien. {PURPLE>Het onontdekte is altijd groter}. Dat voelt niet als dreiging — als uitnodiging.'),
      ...
      ans(32, 5, '{ORANGE>Het systeem}. Ik kan sturen, buigen, transformeren — maar het geheel beweegt op een schaal die ik niet bepaal. Die grens doorzie ik scherp.'),
    ],
  },
  ...
  // ─── Q33 (Key 3, Mirror) ───
  {
    ...
    domain: 'mysterie',
    answers: [
      ans(33, 0, 'Ik {ORANGE>vang op} wat het achterlaat. Niet het onbeheersbare zelf — de {ORANGE>mensen} die erdoor geraakt worden. Die reflex ken ik.'),
      ans(33, 1, '{PURPLE>Ik ga erop af}. Niet om het te overwinnen — maar stilzitten is dodelijker dan verliezen.'),
      ans(33, 2, 'Ik vertrouw erop dat het ergens goed voor is. Die {ORANGE>overgave} werkt als instrument — ook als ik niet zie waarvoor.'),
  ...
  // ─── Q34 (Key 4, Standard) ───
  {
    ...
    domain: 'mysterie',
    answers: [
      ans(34, 0, 'Toen ik besefte {PURPLE>dat liefde niet genoeg was om iemand te houden}. Dat was niet oké. Maar het was eerlijk.'),
      ...
      ans(34, 4, 'Toen het systeem won en ik er niks aan kon doen. Dat voelde als verraad — door de werkelijkheid zelf.'),
      ans(34, 5, 'Toen ik doorhad {ORANGE>dat kennis niets oploste}. Die les werkt als mijn strengste correctie — weten is niet genoeg.'),
    ],
  },
  ...
  // ─── Q35 (Key 5, Mirror) ───
  {
    ...
    answers: [
      ...
      ans(35, 4, 'Waar mijn {ORANGE>zorg de ander kleiner maakt} in plaats van sterker. Die grens herken ik als mijn gevaarlijkste valkuil.'),
  ...
  // ─── Q36 (Key 6, Standard) ───
  {
    ...
    answers: [
      ...
      ans(36, 3, 'Het moment van {ORANGE>transformatie}. Die seconde waarop iets verandert — die dynamiek doorzie ik als het enige dat echt telt.'),
